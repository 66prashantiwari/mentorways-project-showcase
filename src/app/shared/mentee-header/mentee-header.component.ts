...
@Component({
  selector: 'app-mentee-header',
  templateUrl: './mentee-header.component.html',
  styleUrls: ['./mentee-header.component.scss'],
})
export class MenteeHeaderComponent implements OnInit {
